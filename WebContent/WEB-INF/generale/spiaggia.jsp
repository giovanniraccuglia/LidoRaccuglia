...
<html lang="it">
   <head>
      <script src="js/generale/spiaggia.js"></script>
      <style>
         .grid-container {
         overflow-x: scroll;
         display: grid;
         ...
         <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
               ...
               <div class="modal-header">
                  <h2 class="modal-title w3-opacity">Spiaggia</h2>
               </div>
               <!-- Modal body -->
               <div id="divSpiaggia" class="modal-body">
                  <!-- Date picker -->
               ...
               <div class="modal-footer" style="font-style: normal">
                  <button id="closeSpiaggia" type="button" class="btn btn-secondary" data-dismiss="modal" ><i class="fa fa-close"></i> close</button>
               </div>
            </div>
         </div>
      </div>
